...
public sealed class AskBranchOpsTools(
    ...
    IOptions<AiOptions> options)
{
    ...
    public AskBranchOpsTools BindScope(Guid? branchId, string branchScope)
    {
        _branchId = branchId;
    ...
    public AskScopeInfo GetCurrentBranchScope()
        => new(_branchId, _branchScope);

    [Description("List branches visible in the current request scope.")]
    public Task<IReadOnlyList<AskBranchInfo>> ListAccessibleBranches(
    ...
    public Task<AskDashboardSummary> GetDashboardSummary(CancellationToken ct = default)
    ...
    public Task<AskSalesChart> GetSalesChart(
    ...
    public Task<AskDailySalesReport> GetDailySales(
    ...
    public Task<AskTopProductsReport> GetTopProducts(
    ...
    public Task<AskBranchPerformanceReport> GetSalesByBranch(
        [Description("Lookback window in days.")] int days = 30,
        CancellationToken ct = default)
